<x-layout>
    <div class="container-fluid pt-5">
        ...
        <div class="row justify-content-center pt-5">
            <div class="col-md-8">
                <div class="row justify-content-center">
                    @if ($article_to_check->images && $article_to_check->images->count())
            ...
            <div class="col-md-4 ps-4 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <h3>{{ __("ui.author") }}: {{ $article_to_check->user?->name ?? __("ui.unknownUser") }}</h3>
                    <h4>{{ $article_to_check->price }}€</h4>
                    <h4 class="fst-italic text-muted">
                        #{{ __("ui." . ($article_to_check->category?->name ?? 'unknown')) }}
                    </h4>
        ...
        <div class="row justify-content-center align-items-center height-custom text-center">
            <div class="col-12">
                <h1 class="fst-italic display-4">{{ __("ui.noRevision") }}</h1>
